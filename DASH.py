...
app = Dash(
    __name__,
    title="Ekhishini Live Dashboard",
...
@server.route("/health")
def health() -> Response:
    return jsonify({"status": "ok", "service": "ekhishini-dashboard"})
...
def optional_basic_auth() -> Response | None:
    ...
    return Response(
        ...
        401,
        {"WWW-Authenticate": 'Basic realm="Ekhishini Dashboard"'},
    )
    ...
    children=[
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            [
                                html.H1("Ekhishini Live Dashboard"),
        ...
        html.Main(
            ...
            children=[
                ...
                html.Footer(
                    [
                        html.Span("Ekhishini Stokvel Dashboard"),
